...
function showMapTooltip(point, e, i, g) {
  ...
  if (group === "armies") {
    ...
    return tip(e.target.parentNode.dataset.name + gridSuffix + ". Click to edit");
  }
  ...
  if (group === "markers") {
    ...
    return tip(`Marker${gridSuffix}. Click to edit. Hold Shift to not close the assosiated note`);
  }
